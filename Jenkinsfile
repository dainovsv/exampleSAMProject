pipeline {
  ...
  environment {
    ...
    TESTING_PIPELINE_EXECUTION_ROLE = 'arn:aws:iam::135727629848:role/aws-sam-cli-managed-dev-pipe-PipelineExecutionRole-DZTY9LRV7LER'
    TESTING_CLOUDFORMATION_EXECUTION_ROLE = 'arn:aws:iam::135727629848:role/aws-sam-cli-managed-dev-p-CloudFormationExecutionR-19DB86TOF8ATW'
    TESTING_ARTIFACTS_BUCKET = 'aws-sam-cli-managed-dev-pipeline-artifactsbucket-ehqcdj9y0rjr'
    ...
    PROD_PIPELINE_EXECUTION_ROLE = 'arn:aws:iam::135727629848:role/aws-sam-cli-managed-prod-pip-PipelineExecutionRole-E9L7E54JZNO1'
    PROD_CLOUDFORMATION_EXECUTION_ROLE = 'arn:aws:iam::135727629848:role/aws-sam-cli-managed-prod-CloudFormationExecutionR-14OX05V9G2F66'
    PROD_ARTIFACTS_BUCKET = 'aws-sam-cli-managed-prod-pipeline-artifactsbucket-1nep3lh5wsr2j'
    // If there are functions with "Image" PackageType in your template,
